class end extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.bitmapText(game.config.width/2, 3 * game.config.height/4, "publicPixel", "Press T to go back to the title screen", 16).setOrigin(0.5);
        this.add.bitmapText(980, 580, "publicPixel", "pretend this is a good end screen too", 8).setOrigin(1);
